...
const extern SimpleWindowGeometryChangeBlock shiftItThirdsLeft;
const extern SimpleWindowGeometryChangeBlock shiftItThirdsCenter;
const extern SimpleWindowGeometryChangeBlock shiftItThirdsRight;
